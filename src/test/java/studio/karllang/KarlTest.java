...
class KarlTest {
  ...
  void testMain() {
    ...
    Assertions.assertEquals(
        List.of(new String[] {"Hello, World!"}), consoleCaptor.getStandardOutput());
  }
  ...
  void testElse() {
    ConsoleCaptor consoleCaptor = new ConsoleCaptor();
    String[] expected = {
      "Test #1 success", "Test #2 success", "Test #3 success", "Test #4 success"
    };
  ...
  void mathTest() {
    ConsoleCaptor consoleCaptor = new ConsoleCaptor();
    String[] expected = {
      "17", "14", "22", "14", "36", "36", "36", "7.3333335", "6", "7.3333335", "25"
    };
