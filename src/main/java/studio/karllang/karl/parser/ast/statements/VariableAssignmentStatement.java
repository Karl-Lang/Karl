...
public class VariableAssignmentStatement extends Statement {
  ...
  public VariableAssignmentStatement(
      String name, Expression expression, String fileName, int line, int pos) {
  ...
  public void eval() {
    ...
    if (val.getType() == value.getType()
        || (val.getType() == TokenType.STRING && value.getType() == TokenType.NULL)) {
