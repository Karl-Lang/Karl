...
public class LogicalExpression extends Expression {
  ...
  public LogicalExpression(
      TokenType operator, Expression left, Expression right, String fileName, int line, int pos) {
    this.left = left;
    this.right = right;
      ...
      if (right != null) {
        ...
        if (leftValue.getType() == TokenType.NULL || rightValue.getType() == TokenType.NULL) {
          ...
          return new BooleanValue(
              LogicalOperators.compare(leftValue, rightValue, operator, fileName, line, pos));
        }
      } else {
